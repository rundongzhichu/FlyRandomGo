...
// alert(datacp);
if(city01!=null && city02!=null && date02!=null) {
...
//xmlhttp.send(null);
    ...
    depdes["citySelect01"] = city02;
    depdes["citySelect02"] = city01;
    depdes["datetimepicker1"] = date02;
...
function btn02(){
    window.location.href = "back_display.html";
}
